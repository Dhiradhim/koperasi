                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <?php
                                    ...
                                    $query = "SELECT a.*, u.user_id FROM users as u, anggota as a WHERE u.no_anggota=a.no_anggota AND a.no_anggota='$no_anggota'";
                                    $sql = mysqli_query($con, $query);
                                    $data = mysqli_fetch_array($sql);
                                    foreach($data as $key=>$value) {$$key=$value;}
                                ?>
                                <!-- QUERY -->
                                <center><h1>Edit Detail <?=ucfirst($role)?></h1></center>
                                <br><br>
                                    ...
                                    <form method="post" action="user_edit_save.php">
                                        ...
                                        <div class="form-row">
                                            <div class="form-group col-md-4">
                                                ...
                                                <input type="text" hidden required class="form-control" name="role" placeholder="Username" value="<?=$role?>">
                                            </div>
                                            <div class="form-group col-md-4">
